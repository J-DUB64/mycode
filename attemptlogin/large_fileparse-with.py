...
with open("/home/student/mycode/attemptlogin/keystone.common.wsgi")as kfile:
    ...
    for line in kfile:
        ...
        if "- - - - -] Authorization failed" in line:
            loginfail += 1 #this is the same as loginfial = loginfail +1
        #the following elif asgumentation MUST be AFTER we check for a fail
        #This statement assumes the if statement above it tested false
        elif "-] Authorization failed" in line: #can ONLY be true if the "if" was 
